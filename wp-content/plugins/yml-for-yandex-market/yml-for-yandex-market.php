...
class YmlforYandexMarket {
 ...
 function yfym_save_post_product_function ($post_id, $post, $update) {
	...
	if (!isset($_POST['yfym_cost'])) {return;}
 ...
 public function yfym_admin_notices_function() {
  ...
  if ($yfym_version !== '2.0.1') {
	print '<div class="notice error is-dismissible"><p>'. __('Plugin has been updated to version 2.0.1. Please resave the plugin settings', 'yfym'). ' YML for Yandex Market!</p></div>';
  }
