...
class SettingsWooCartFacade
{
    ...
    private function _getFields()
    {
        $settings = array(
            ...
            'hideCartOnMobileDevices' => array(
                'caption' => $this->_plugin->getLang(
                    'Hide Cart on Mobile Devices'
                ),
                'lable' => $this->_plugin->getLang(
                    'Disable display cart on mobile devices'
                ),
                'type' => 'input_checkbox',
                'default' => 0,
                'fieldsetKey' => 'general',
            ...
            'quantitySpinnerSkin' => array(
                ...
                'values' => array(
                    ...
                    'skinPlusMinus' => $this->_plugin->getLang(
                        'Skin 2'
                    )
                ),
                'default' => 1,
                'backlight' => 'light',
                'fieldsetKey' => 'general',
                'eventClasses' => 'displayQuantitySpinner'
            ),
            ...
            'popupCrossSellProducts' => array(
                'caption' => $this->_plugin->getLang(
                    'Cross Sell Products'
                ),
                'lable' => $this->_plugin->getLang(
                    'Enable displaying Cross Sell Products in popup'
                ),
                'hint' => $this->_plugin->getLang(
                    'Allow to display woocommerce cross     
                    sell products on modal popup window'
                ),
                'type' => 'input_checkbox',
                'default' => 0,
                'event' => 'visible',
