jQuery(document).ready(function()
{
    ...
    jQuery('.festi-color-selector').on('mouseenter touchend', function() {        
          
        var firstChildName = this.firstElementChild.name;
        
        if (typeof firstChildName != "string"){            
            return;
        }        
        
        var element = '.festi-color-selector.festi-cart-' + firstChildName;
