...
<div itemscope itemtype="http://schema.org/Product" id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php
		...
		if( $sidebar == 'full' ){
		$bottom_class = 'col-lg-9 col-md-8 col-sm-12 col-xs-12 tab-col-9';
	?>
		<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 tab-col-3">
			<?php Ya_related_product( 8, esc_html__( 'Related Products', 'shoppystore' ) ); ?>
		</div>
		<?php } ?>
		<div class="<?php echo $bottom_class; ?> description">
		<?php
			/**
